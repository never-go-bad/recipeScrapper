...
def generateServingsAndTime(recipe): 
		if "servings" in recipe or "activeTime" in recipe or "totalTime":
			html = "<H1 style=\"font-family:Helvetica; font-weight: lighter; background-color: darkgray; padding: 5px ; font-size: 14pt\">SERVINGS & COOKING TIME</H1><div style=\"font-family:Helvetica; font-size: 12pt\">"
